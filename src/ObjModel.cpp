   ...
   if (vertstrs.size() >= 3) {
      for (unsigned int i = 0 ; i < vertstrs.size() ; ++i) {
         ...
         if (subwords.size() == 3) {
            ...
            /// v/vt/vn
            if (subwords.size() == 3) {
               if (3 != sscanf(vertstrs[i].c_str() , "%u/%u/%u" , &vindex , &vtindex , &vnindex)) {
                  error = true;
               }
            }
            else if (subwords[1][0] == '\0') {
               if (2 != sscanf(vertstrs[i].c_str() , "%u//%u" , &vindex , &vnindex)) {
                  error = true;
               }
            }
            else {
            ...
            /// We have v, and vt
            if (2 != sscanf(vertstrs[i].c_str() , "%u/%u" , &vindex , &vtindex)) {
               error = true;
            }
         }
         else if (subwords.size() == 1) {
            /// We just have v
            if (1 != sscanf(vertstrs[i].c_str() , "%u" , &vindex)) {
               error = true;
            }
         }
         else {
